...
import com.example.feign.AdminBankServiceFeign;
...
import com.example.mapper.CashRechargeMapper;
...
public class CashRechargeServiceImpl extends ServiceImpl<CashRechargeMapper, CashRecharge> implements CashRechargeService{
    ...
    @Override
    public boolean cashRechargeAudit(Long aLong, CashRechargeAuditRecord auditRecord) {
        // 同一时刻，只允许一名员工审核,加锁
